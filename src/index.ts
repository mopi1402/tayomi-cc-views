...
// through ONE seam, the DisplayHost a caller hands to slice()/transform().
//
...
// what a carrier learned about the zone, so such a host can dress a view exactly like
// the decorator does.
...
// The block-data format. Exported because a host may have a second reader of the SAME
...
// behaviour (runMessageDisplayHook), and the process-free storey under it for a host
// that owns its own edge or a test (handleMessageDisplay).
export {
