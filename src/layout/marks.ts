// The two control channels a rendered line can carry, and the one question the framer
// asks about them.
//
...
// strings and has no other channel. Both marks therefore travel ON the line.
